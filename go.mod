module github.com/gardener/gardener-extension-diki
...
require (
	github.com/gardener/diki-operator v0.1.0
	github.com/gardener/gardener v1.150.2
...
require (
	...
	github.com/gardener/gardener/hack/tools v1.150.2 // indirect
